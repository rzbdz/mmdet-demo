...
# model settings
# load_from = "C:/Users/PanJu/mmdetection/work_dirs/yolov3_voc/latest.pth"
model = dict(
    type='YOLOV3',
    backbone=dict(
        type='Darknet',
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file =data_root + 'VOC2020/ImageSets/Main/train.txt',
            img_prefix=data_root + 'VOC2020/',
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'VOC2020/ImageSets/Main/val.txt',
        img_prefix=data_root + 'VOC2020/',
